...
import com.vi.tenantservice.consultingtypeservice.generated.web.model.RequiredComponentsDTO;
 ...
 */
@JsonPropertyOrder({
  ConsultingTypeDTO.JSON_PROPERTY_TENANT_ID,
  ConsultingTypeDTO.JSON_PROPERTY_DESCRIPTION,
  ConsultingTypeDTO.JSON_PROPERTY_GROUPS,
  ConsultingTypeDTO.JSON_PROPERTY_SLUG,
  ConsultingTypeDTO.JSON_PROPERTY_IS_SUBSEQUENT_REGISTRATION_ALLOWED,
  ConsultingTypeDTO.JSON_PROPERTY_SHOW_ASKER_PROFILE,
  ConsultingTypeDTO.JSON_PROPERTY_IS_VIDEO_CALL_ALLOWED,
  ConsultingTypeDTO.JSON_PROPERTY_LANGUAGE_FORMAL,
  ConsultingTypeDTO.JSON_PROPERTY_CONSULTANT_BOUNDED_TO_CONSULTING_TYPE,
  ConsultingTypeDTO.JSON_PROPERTY_SEND_FURTHER_STEPS_MESSAGE,
  ConsultingTypeDTO.JSON_PROPERTY_FURTHER_INFORMATION,
  ConsultingTypeDTO.JSON_PROPERTY_URLS,
  ConsultingTypeDTO.JSON_PROPERTY_REGISTRATION,
  ConsultingTypeDTO.JSON_PROPERTY_GROUP_CHAT,
  ConsultingTypeDTO.JSON_PROPERTY_WHITE_SPOT,
  ConsultingTypeDTO.JSON_PROPERTY_WELCOME_MESSAGE,
  ConsultingTypeDTO.JSON_PROPERTY_SESSION_DATA_INITIALIZING,
  ConsultingTypeDTO.JSON_PROPERTY_ROLES,
  ConsultingTypeDTO.JSON_PROPERTY_REQUIRED_COMPONENTS
})
...
public class ConsultingTypeDTO {
  ...
  **/
  ...
  public ConsultingTypeDTO whiteSpot(ExtendedConsultingTypeResponseDTOAllOfWhiteSpot whiteSpot) {
  ...
  **/
  ...
  public ConsultingTypeDTO welcomeMessage(ExtendedConsultingTypeResponseDTOAllOfWelcomeMessage welcomeMessage) {
  ...
  **/
  ...
  public ConsultingTypeDTO sessionDataInitializing(ExtendedConsultingTypeResponseDTOAllOfSessionDataInitializing sessionDataInitializing) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tenantId, description, groups, slug, isSubsequentRegistrationAllowed, showAskerProfile, isVideoCallAllowed, languageFormal, consultantBoundedToConsultingType, sendFurtherStepsMessage, furtherInformation, urls, registration, groupChat, whiteSpot, welcomeMessage, sessionDataInitializing, roles, requiredComponents);
  }
