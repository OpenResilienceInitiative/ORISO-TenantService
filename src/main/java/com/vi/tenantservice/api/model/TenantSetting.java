...
public enum TenantSetting {
  ...
  FEATURE_AUDIO_CALLS_ONE_ON_ONE_CHATS_ENABLED(
      List.of(UserRole.TENANT_ADMIN, UserRole.SINGLE_TENANT_ADMIN)),
  FEATURE_AUDIO_CALLS_GROUP_CHATS_ENABLED(List.of(UserRole.TENANT_ADMIN, UserRole.SINGLE_TENANT_ADMIN)),
  ...
  FEATURE_VIDEO_CALLS_ONE_ON_ONE_CHATS_ENABLED(
      List.of(UserRole.TENANT_ADMIN, UserRole.SINGLE_TENANT_ADMIN)),
  FEATURE_VIDEO_CALLS_GROUP_CHATS_ENABLED(List.of(UserRole.TENANT_ADMIN, UserRole.SINGLE_TENANT_ADMIN)),
