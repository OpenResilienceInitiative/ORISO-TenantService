...
/**
 * SpringFox configuration - disabled for Spring Boot 4.0 compatibility. Springfox is not compatible
 * with Spring Boot 4.0/Spring Framework 7. API documentation is generated via OpenAPI Generator
 * from YAML specs.
 */
@Configuration
